...
namespace Microsoft.Xbox.Services.Client
{
    public class PlayerAuthentication : MonoBehaviour
    {
        ...
        public TextMeshProUGUI gamertag;
        ...
        public void SignIn()
        {
            ...
            this.signInPanel.GetComponent<Button>().interactable = false;
        ...
        public void Update()
        {
            ...
            if (this.AllowSignInAttempt && (Input.GetKeyDown(KeyCode.X) || Input.GetKeyDown(KeyCode.JoystickButton2)))
            {
                this.SignIn();
            }

            if (!this.AllowSignInAttempt && (Input.GetKeyDown(KeyCode.Y) || Input.GetKeyDown(KeyCode.JoystickButton3)))
            {
                this.SignOut();
            }
        }
